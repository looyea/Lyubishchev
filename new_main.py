# -*- coding: utf-8 -*-
"""
Created on Fri Oct  2 07:49:59 2020
...
'''
img_df = gs.time_class_static(data, pre_month, cur_month, np.sum)
img_df.plot(kind='barh')
img_df = gs.event_class_static(data, pre_month, cur_month, np.sum)
img_df.plot(kind='barh')
pvt = gs.monthly_time_class_trend(data, cur_month)
gs.simple_plot(pvt)
'''